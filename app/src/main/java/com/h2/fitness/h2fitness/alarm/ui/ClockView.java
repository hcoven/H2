...
public class ClockView extends SeekBar {
    ...
    public void onDraw(Canvas c) {
        int primaryColor = com.h2.fitness.h2fitness.alarm.ui.Theme.get(App.getState().settings().theme()).primaryColor;
        int accentColor = com.h2.fitness.h2fitness.alarm.ui.Theme.get(App.getState().settings().theme()).accentColor;
