...
public class AbsFragment extends Fragment {
    ...
    List<VideoModel> mAllVideoModelOfAbs;
    ...
    private ResultAdober mAbsAdopter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mAllVideoModelOfAbs != null) {
            mAllVideoModelOfAbs.clear();
        }
    }
...
/////////////////////////
        mAllVideoModelOfAbs = taskList.getTasks();
        mAbsAdopter = new ResultAdober(mAllVideoModelOfAbs);
        recyclerView = (RecyclerView) view.findViewById(R.id.absrecycleview);
        ...
        recyclerView.setAdapter(mAbsAdopter);
        //    mWorkoutAdopter.notifyDataSetChanged();
    ...
    private void collectingData() {
        if (!(mId == null)) {
            ...
            String ref = Config.FIREBASE_USER_FILES + "abs/" + type + "/";
...
//                    collectPhoneNumbers((Map<String,Object>) dataSnapshot.getValue());
    ...
    private void updateUI() {
        ...
        if (mAbsAdopter != null) {
            ...
            mAbsAdopter.notifyDataSetChanged();
        }
    }
