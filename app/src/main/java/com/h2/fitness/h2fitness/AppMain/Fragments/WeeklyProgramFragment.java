...
public class WeeklyProgramFragment extends Fragment {

    final FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
    List<VideoModel> mAllVideoModelOfweek;
    ...
    private ResultAdober mWeeklyAdopter;

    public static Fragment getInstance() {
        Bundle bundle = new Bundle();
        Fragment fragment = new WeeklyProgramFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mAllVideoModelOfweek != null) {
            mAllVideoModelOfweek.clear();
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_weekly_program, container, false);


        mAllVideoModelOfweek = taskList.getTasks();
        PrefManager pref = new PrefManager(getApplicationContext());
        pref.clearSession();
        pref.createfile("weekly");
        collectingData();

        mWeeklyAdopter = new ResultAdober(mAllVideoModelOfweek);
        recyclerView = (RecyclerView) view.findViewById(R.id.weeklyrecycleview);
        ...
        recyclerView.setAdapter(mWeeklyAdopter);
            //mWeeklyAdopter.notifyDataSetChanged();
    ...
    private void collectingData() {
        if (!(mId == null)) {
            //pdialog = ProgressDialog.show(getContext(), "Please Wait...", "Processing...");//was commented


            String type = pref.gettype();
            String ref = Config.FIREBASE_USER_FILES + "weekly/" + type + "/";
