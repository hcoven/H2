...
public class FriendPagerViewFragment extends Fragment {
    ...
    public static Fragment createFragment() {
        ...
        Fragment fragment = new FriendPagerViewFragment();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new RequestListFragment(), "REQUEST ");
        adapter.addFragment(new AddFreindsFragment(), " ADD FRIENDS ");
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_UP && keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    if (user.equals("admin@gmail.com")) {
                        ...
                        fragment = AdminPagerViewFragment.createFragment();
