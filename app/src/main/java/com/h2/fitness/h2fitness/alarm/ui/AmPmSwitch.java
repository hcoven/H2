...
public class AmPmSwitch extends ToggleButton {
    ...
    public void onDraw(Canvas c) {
        int colorOff = com.h2.fitness.h2fitness.alarm.ui.Theme.get(App.getState().settings().theme()).primaryColor;
        int colorOn = com.h2.fitness.h2fitness.alarm.ui.Theme.get(App.getState().settings().theme()).accentColor;
