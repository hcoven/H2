...
public class WorkOutFragment extends Fragment {
    ...
    ArrayList<VideoModel> mAllVideoModelOfWorkout;
    ...
    private ResultAdober mWorkoutAdopter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mAllVideoModelOfWorkout != null) {
            mAllVideoModelOfWorkout.clear();
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAllVideoModelOfWorkout = taskList.getTasks();
//////////////////////////////
        /// for the new view
//        PrefManager pref = new PrefManager(getApplicationContext());
//        pref.clearSession();
//        pref.createfile("workout");
//        collectingData();

        //////////////////
        mWorkoutAdopter = new ResultAdober(mAllVideoModelOfWorkout);
        recyclerView = (RecyclerView) view.findViewById(R.id.workoutrecycleview);
        ...
        recyclerView.setAdapter(mWorkoutAdopter);
    ...
    private void collectingData() {
        if (!(mId == null)) {
            ...
            String ref = Config.FIREBASE_USER_FILES + "workout/" + type + "/";
